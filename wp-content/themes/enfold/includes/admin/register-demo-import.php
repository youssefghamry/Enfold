 ...
 * ===============
 *
 * Detailed info you find here: https://kriesi.at/documentation/enfold/import-demos/#creating-demos
 *
 * in short:
 *
...
$avia_elements[] =	array(
					...
					'demo_name'	=> 'default',
					'download'	=> 166,
					'demo_img'	=> 'https://kriesi.at/themes/demo-downloads/wp-content/uploads/sites/85/2021/04/default.jpg'
				);
...
$avia_elements[] =	array(
					'slug'		=> 'demo',
					'name'		=> __( 'Import: Agency - Enfold Parallax Demo', 'avia_framework' ),
					'desc'		=> 	 "<p><strong>{$what_get} <a href='https://kriesi.at/themes/enfold-parallax/' target='_blank'>{$online_demo}</a></strong></p>"
									."<h4 class='av-before-plugins'>" . __( 'Recommended Plugins:', 'avia_framework' ) . '</h4><ul>'
									.'<li>' . __( 'None', 'avia_framework' ) . '</li>'
									.'</ul>'
									."<h4 class='av-before-plugins'>" . __( 'Demo Images included:', 'avia_framework' ) . '</h4><ul>'
					...
					'demo_name'	=> 'parallax',
					'download'	=> 417,
					'demo_img'	=> 'https://kriesi.at/themes/demo-downloads/wp-content/uploads/sites/85/2022/05/parallax.jpg'
				);
...
$avia_elements[] =	array(
					...
					'desc'		=> 	 "<p><strong>{$what_get} <a href='https://kriesi.at/themes/enfold-church/' target='_blank'>{$online_demo}</a></strong></p>"
									...
									."<li>or <a href='https://theeventscalendar.pxf.io/pro' target='_blank'>The Events Calendar PRO</a></li>"
									.'</ul>'
									."<h4 class='av-before-plugins'>" . __( 'Demo Images included:', 'avia_framework' ) . '</h4><ul>'
									.'<li>' . __( 'All', 'avia_framework' ) . '</li>'
									.'</ul>',
