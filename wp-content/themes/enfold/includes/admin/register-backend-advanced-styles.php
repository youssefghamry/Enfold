...
$weight = $avia_admin_values['font-weight'];
$transform = $avia_admin_values['text-transform'];
$align = $avia_admin_values['text-align'];
$decoration = $avia_admin_values['text-decoration'];
$display = $avia_admin_values['display'];
