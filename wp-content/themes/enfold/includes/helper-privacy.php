...
if( ! class_exists( 'av_privacy_class' ) )
{
	class av_privacy_class
	{
		...
		protected function __construct()
		{
			...
			/**
			 * Widget block editor calls wp_footer and this displays content of this class
			 *
			 * @since 4.9
			 */
...
//			$sc_content .= '<br />';
		...
		public function get_default_modal_popup_content( $filter_options = 'filter' )
		{
			...
			$c .= '<br /><br />';
			$c .= __( 'Because these cookies are strictly necessary to deliver the website, refusing them will have impact how our site functions. You always can block or delete cookies by changing your browser settings and force blocking all cookies on this website. But this will always prompt you to accept/refuse cookies when revisiting our site.', 'avia_framework' );
			$c .= '<br /><br />';
