	...
	function avia_events_dynamic_css( $output, $color_set )
	{
		...
		foreach( $color_set as $key => $colors ) // iterates over the color sets: usually $key is either: header_color, main_color, footer_color, socket_color
		{
			...
			if( $key == '.main_color' )
			{
				...
				$key #tribe-events-pg-template .tribe-events-notices, $key #tribe-events-pg-template .tribe-events-notices strong, $key .tribe-common--breakpoint-medium.tribe-events .tribe-common-c-btn.tribe-events-c-search__button,
				$key .tribe-common .tribe-common-c-btn-border, $key .tribe-common a.tribe-common-c-btn-border,
				...
				.tribe-theme-enfold $key .tribe-events .datepicker .day.active, .tribe-theme-enfold $key .tribe-events .datepicker .day.active.focused, 
				.tribe-theme-enfold $key .tribe-events .datepicker .day.active:focus, .tribe-theme-enfold $key .tribe-events .datepicker .day.active:hover, 
				.tribe-theme-enfold $key .tribe-events .datepicker .month.active, .tribe-theme-enfold $key .tribe-events .datepicker .month.active.focused, 
				.tribe-theme-enfold $key .tribe-events .datepicker .month.active:focus, .tribe-theme-enfold $key .tribe-events .datepicker .month.active:hover, 
				.tribe-theme-enfold $key .tribe-events .datepicker .year.active, .tribe-theme-enfold $key .tribe-events .datepicker .year.active.focused, 
				.tribe-theme-enfold $key .tribe-events .datepicker .year.active:focus, .tribe-theme-enfold $key .tribe-events .datepicker .year.active:hover{
					background: $primary;
					color: $constant_font;
