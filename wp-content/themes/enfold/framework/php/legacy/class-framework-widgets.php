 ...
 *
 * @deprecated since 4.9 - replaced by enfold\framework\php\widgets\class-widget-loader.php
 *
 * Only kept for backwards in case user needs something.
 * If loaded, remove enfold\framework\php\widgets\class-widget-loader.php.
