...
if( ! class_exists( 'Avia_Instagram_Feed' ) )
{
	class Avia_Instagram_Feed
	{
		...
		public function __construct()
		{
			...
			add_filter( 'avf_widget_loader_widget_classes', array( $this, 'handler_avf_widget_loader_widget_classes'), 10, 1 );
		}
		 ...
		 * @return string
		 */
		public function handler_avf_widget_loader_widget_classes( array $widgets = array() )
		{

			$widgets['smash_instagram'] = array(
												'class'	=> 'Avia_Instagram_Feed_Widget',
												'file'	=> trailingslashit( dirname( __FILE__ ) ) . 'class-avia-instagram-feed-widget.php'
											);
